...
class ProductInfo extends AbstractInfo
{
     ...
     * @return array
     */
    public function getChildCount($product)
    {
        $results = array();
        ...
        $results['releases']  = $repositoryRl->countReleasesByProduct($product);
        $results['users'] = $repositoryUPR->countUsersByProduct($product);
